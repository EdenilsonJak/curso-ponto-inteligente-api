...
import com.ejsistemas.pontointeligente.api.dtos.CadastroPFDto;
...
import com.ejsistemas.pontointeligente.api.enums.PerfilEnum;
...
public class CadastroPFController {
	...
	/**
	 * Popula o DTO de cadastro com os dados do fucionário e empresa.
	 * 
	 * @param funcionario
	...
	/**
	 * Verifica se a empresa está cadastrada e se funcionário não existe na base de dados
	 * 
	 * @param cadastroPFDto
	 * @param result
	 */

	private void validarDadosExistente(CadastroPFDto cadastroPFDto, BindingResult result) {
		Optional<Empresa> empresa = this.empresaService.buscarPorCnpj(cadastroPFDto.getCnpj());
