...
import com.ejsistemas.pontointeligente.api.dtos.LancamentoDto;
...
import com.ejsistemas.pontointeligente.api.enums.TipoEnum;
...
public class LancamentoController {
	...
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result) throws ParseException{
		...
		if(lancamentoDto.getId().isPresent()){
			...
			if(lanc.isPresent()){
				...
				result.addError(new ObjectError("lancamento", "Lançamento não encontradado"));
			}
	...
	/**
	 * Valida uma funcionário, verificando se ele é existente e válido no sistema.
	 * 
	 * @param lancamentoDto
	 * @param result
	 * 
	...
	private void validarFuncionario(LancamentoDto lancamentoDto, BindingResult result){
		if(lancamentoDto.getFuncionarioId() == null){
			result.addError(new ObjectError("funcionario", "Funcionáro não informado."));
			return;
		}
		
		log.info("Válidando funcionário id {}", lancamentoDto.getFuncionarioId());
