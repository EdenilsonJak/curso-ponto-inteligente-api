package com.ejsistemas.pontointeligente.api.repositories;
...
public class FuncionarioRepositoryTest {
	...
	private Funcionario obterDadosFuncionario(Empresa empresa) throws NoSuchAlgorithmException {
		...
		funcionario.setQtdHorasAlmoco(new Float(11.10));
		funcionario.setQtdHorasTrabalhoDia(new Float(02.30));
